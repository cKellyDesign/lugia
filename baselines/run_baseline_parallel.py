...
if __name__ == '__main__':
    ...
    learn_steps = 40
    file_name = '' #'session_e41c9eff/poke_250871808_steps'
    ...
    if exists(file_name + '.zip'):
        ...
        model = PPO('CnnPolicy', env, verbose=1, n_steps=ep_length, batch_size=512, n_epochs=1, gamma=0.999, tensorboard_log='')
